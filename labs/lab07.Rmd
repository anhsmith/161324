...
3. Compute the accuracy of each model on each dataset.
...
A few of these look decidedly non-normal! We could also assess the balance in the data by just tabling up the number of each window type:
