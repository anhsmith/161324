...
With $C \ge 3$ classes, we have two boundaries.
...
The `conf_mat()` function from `yardstick` can be used to evaluate performance. The `accuracy()` function gives classification success rates.
...
.right-plot[
```{r anim1, echo=FALSE, warning=FALSE, message=FALSE}
xkd |> 
  pivot_longer(cols = y1:y7) |> 
  ggplot() +
